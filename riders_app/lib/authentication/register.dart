...
import 'package:firebase_storage/firebase_storage.dart' as f_store;
    ...
    else
      {
        if(passwordController.text == confirmPasswordController.text){
          if(confirmPasswordController.text.isNotEmpty && emailController.text.isNotEmpty && nameController.text.isNotEmpty && phoneController.text.isNotEmpty && locationController.text.isNotEmpty){
            ...
            f_store.Reference reference = f_store.FirebaseStorage.instance.ref().child("admins").child(fileName);
            f_store.UploadTask uploadTask = reference.putFile(File(imageXFile!.path));
            f_store.TaskSnapshot taskSnapshot = await uploadTask.whenComplete(() {});
          ...
          else
            {
              showDialog(context: context,
                  builder: (c) {
                    return ErrorDialog(
                      message: "Please enter the complete required info for Registration.",
                    );
                  }
              );
            }
            ...
            child: Column(
              children: [
                ...
                CustomTextField(
                  ...
                  hintText: "Current Address/Location",
                  isObsecre: false,
                  enabled: false,
                ),
                Container(
