...
class HostelMaingateScreen extends StatefulWidget {

  @override
  State<HostelMaingateScreen> createState() => _HostelMaingateScreenState();
}

class _HostelMaingateScreenState extends State<HostelMaingateScreen> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: SimpleAppBar(title: "Hostel/Main Gate",),
        body: ListView(
          children: [
            //header drawer
            Container(
